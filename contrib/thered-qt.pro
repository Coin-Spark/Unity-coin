...
RESOURCES += src/qt/unity.qrc src/qt/unity_locale.qrc

TRANSLATIONS += src/qt/locale/unity_bg.ts \
                src/qt/locale/unity_de.ts \
                src/qt/locale/unity_en.ts \
                src/qt/locale/unity_es.ts \
                src/qt/locale/unity_fi.ts \
                src/qt/locale/unity_fr.ts \
                src/qt/locale/unity_it.ts \
                src/qt/locale/unity_ja.ts \
                src/qt/locale/unity_pl.ts \
                src/qt/locale/unity_pt.ts \
                src/qt/locale/unity_ru.ts \
                src/qt/locale/unity_sk.ts \
                src/qt/locale/unity_sv.ts \
                src/qt/locale/unity_vi.ts \
                src/qt/locale/unity_zh_CN.ts \
                src/qt/locale/unity_zh_TW.ts
