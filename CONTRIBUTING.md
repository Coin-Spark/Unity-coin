...
The unity Core project operates an open contributor model where anyone is
...
The following applies to code changes to the unity Core project, and is not to be
confused with overall unity Network Protocol consensus changes.

Whether a pull request is merged into unity Core rests with the project merge
...
Patches that change unity consensus rules are considerably more involved than
...
Where a patch set proposes to change the unity consensus, it must have been
...
The project leader is the release manager for each unity Core release.
