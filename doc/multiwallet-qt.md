...
In order to support loading of multiple wallets in unity-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is unity.cpp.
...
Changes to unity.cpp
----------------------
unity.cpp is the entry point into unity-qt, and as such, will require some minor modifications to provide hooks for
