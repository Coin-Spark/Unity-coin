                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Unity Wallet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a unity address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and unity: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About unity Core"), this);
    aboutAction->setStatusTip(tr("Show information about unity Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for unity"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your unity addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified unity addresses"));
    ...
    openAction->setStatusTip(tr("Open a unity: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the unity Core help message to get a list with possible unity command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("unity Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to unity network", "", count));
}
...
{
    QString strTitle = tr("unity Core"); // default title
