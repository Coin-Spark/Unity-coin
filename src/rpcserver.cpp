...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* unity features */
        {"unity", "masternode", &masternode, true, true, false},
        {"unity", "masternodelist", &masternodelist, true, true, false},
        {"unity", "mnbudget", &mnbudget, true, true, false},
        {"unity", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"unity", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"unity", "mnsync", &mnsync, true, true, false},
        {"unity", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"unity", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use unityd, or the -server option to unity-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> unity-cli " + methodname + " " + args + "\n";
}
