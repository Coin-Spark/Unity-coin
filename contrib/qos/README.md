...
This means one can have an always-on unityd instance running, and another local unityd/unity-qt instance which connects to this node and receives blocks from it.
