unity Core version 2.3.0 is now available from:

  <https://github.com/unity-project/unity/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/unity-project/unity/issues>

Compatibility
==============

unity Core is extensively tested on multiple operating systems using
...
unity Core should also work on most other Unix-like systems but is not
...
[
  {
    ...
    winner: {
        address: addr,    (string) unity MN Address,
...
[
  {
    ...
    "addr": addr,      (string) Masternode unity address
...
unity Core now enables bloom filters by default to support SPV clients like mobile wallets. This feature can be disabled by using the `-peerbloomfilters` option on startup.
...
- #195 `aee05fe` [ZMQ] ZMQ integration for unity (Mrs-X)
...
### Tests and QA
- #191 `3a778c3` [Tests] Fix the unit test suite for use with unity (Fuzzbawls)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/unity-project-translations/).
