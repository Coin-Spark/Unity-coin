...
/** Utility functions used by the unity Qt UI.
 */
namespace GUIUtil
{
...
// Render unity addresses in monospace font
...
// Parse "unity:" URI into recipient object, return true on successful parsing
