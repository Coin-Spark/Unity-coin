...
This mechanism has been integrated into Bitcore-Node-unity which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/unity-Project/insight-api-unity#web-socket-api](https://github.com/unity-Project/insight-api-unity#web-socket-api) 
* API: [https://github.com/unity-Project/insight-api-unity#swifttx-transactions](https://github.com/unity-Project/insight-api-unity#swifttx-transactions) 
...
By default, the unity Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the unity Core daemon:
